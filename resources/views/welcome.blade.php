...
<head>
  ...
  ================================================== -->
  <meta charset="utf-8">
  <title>IISMEE | Universitas Negeri Surabaya</title>

  <!-- Mobile Specific Metas
  ================================================== -->
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="description" content="IISMEE Landing Page">
  <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=5.0">

  <!-- Favicon -->
  <link rel="shortcut icon" type="image/x-icon" href="https://ilogo.co.id/wp-content/uploads/2021/07/dummy-image-square.jpg" />
  
  <!-- PLUGINS CSS STYLE -->
  <link rel="stylesheet" href="{{ asset('beginning/plugins/bootstrap/bootstrap.min.css') }}">
  <link rel="stylesheet" href="{{ asset('beginning/plugins/themify-icons/themify-icons.css') }}">
  <link rel="stylesheet" href="{{ asset('beginning/plugins/slick/slick.css') }}">
  <link rel="stylesheet" href="{{ asset('beginning/plugins/slick/slick-theme.css') }}">
  <link rel="stylesheet" href="{{ asset('beginning/plugins/fancybox/jquery.fancybox.min.css') }}">
  <link rel="stylesheet" href="{{ asset('beginning/plugins/aos/aos.css') }}">

  <!-- CUSTOM CSS -->
  <link href="{{ asset('beginning/css/style.css') }}" rel="stylesheet">
...
<nav class="navbar main-nav navbar-expand-lg px-2 px-sm-0 py-2 py-lg-0">
  <div class="container">
    <a class="navbar-brand" href="index.html"><img src="https://ilogo.co.id/wp-content/uploads/2021/07/dummy-image-square.jpg" width="20px" height="20px" alt="logo"></a>
	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-md-6 order-2 order-md-1 text-center text-md-left">
				<h1 class="text-white font-weight-bold mb-4">Showcase your app with IISMEE</h1>
				<p class="text-white mb-5">Besides its beautiful design. Laapp is an incredibly rich core framework for you to
					showcase your App.</p>
				<a href="{{Route('dashboard')}}" class="btn btn-main-md">Login Now</a>
			</div>
			<div class="col-md-6 text-center order-1 order-md-2">
				<img class="img-fluid" src="https://ilogo.co.id/wp-content/uploads/2021/07/dummy-image-square.jpg" alt="screenshot">
			</div>
		</div>
	</div>
</section>
		...
		<div class="row">
			<div class="col-lg-6 ml-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-right">
					<img class="img-fluid" src="https://ilogo.co.id/wp-content/uploads/2021/07/dummy-image-square.jpg" alt="iphone">
				</div>
			</div>
		...
		<div class="row">
			...
			<div class="col-lg-6 mr-auto justify-content-center">
				...
				<div class="image-content" data-aos="fade-left">
					<img class="img-fluid" src="https://ilogo.co.id/wp-content/uploads/2021/07/dummy-image-square.jpg" alt="ipad">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row no-gutters">
			<div class="col-lg-6 align-self-center">
				...
				<div class="service-thumb left" data-aos="fade-right">
					<img class="img-fluid" src="https://ilogo.co.id/wp-content/uploads/2021/07/dummy-image-square.jpg" alt="iphone-ipad">
				</div>
			</div>
				...
				<div class="testimonial-slider owl-carousel owl-theme">
					...
					<div class="item">
						<div class="block shadow">
							...
							<!-- Person Thumb -->
							<div class="image">
								<img src="https://ilogo.co.id/wp-content/uploads/2021/07/dummy-image-square.jpg" alt="image">
							</div>
							<!-- Name and Company -->
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<p>Download over 2 million humans .Get <a href="#">IISMEE</a> good App!
...
<footer>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-12 m-md-auto align-self-center">
          <div class="block">
            <a href="#"><img src="https://ilogo.co.id/wp-content/uploads/2021/07/dummy-image-square.jpg" width="50px" height="50px" alt="footer-logo"></a>
            <!-- Social Site Icons -->
  ...
  <div class="text-center bg-dark py-4">
    <small class="text-secondary">Copyright &copy; <script>document.write(new Date().getFullYear())</script>. Designed &amp; Developed by <a href="#">UNESA</a></small class="text-secondary">
  </div>

	<div class="text-center bg-dark py-1">
   <small> <p>Distributed By <a href="https://themewagon.com/">UNESA</a></p></small class="text-secondary">
  </div>
</footer>
  ...
  <!-- JAVASCRIPTS -->
  <script src="{{ asset('beginning/plugins/jquery/jquery.min.js')}}"></script>
  <script src="{{ asset('beginning/plugins/bootstrap/bootstrap.min.js')}}"></script>
  <script src="{{ asset('beginning/plugins/slick/slick.min.js')}}"></script>
  <script src="{{ asset('beginning/plugins/fancybox/jquery.fancybox.min.js')}}"></script>
  <script src="{{ asset('beginning/plugins/syotimer/jquery.syotimer.min.js')}}"></script>
  <script src="{{ asset('beginning/plugins/aos/aos.js')}}"></script>
  <!-- google map -->
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAgeuuDfRlweIs7D6uo4wdIHVvJ0LonQ6g"></script>
  <script src="{{ asset('beginning/plugins/google-map/gmap.js')}}"></script>
  
  <script src="{{asset('beginning/js/script.js')}}"></script>
</body>
